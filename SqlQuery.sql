...
USE [naidisprojekt]
GO
/****** Object:  Table [dbo].[Categories]    Script Date: 31/08/2025 01:02:43 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Listings]    Script Date: 31/08/2025 01:02:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserFavorites]    Script Date: 31/08/2025 01:02:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[UserFavorites](
	[listing_id] [int] NULL,
	[user_id] [int] NULL,
	[user_favorite_id] [int] IDENTITY(1,1) NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[user_favorite_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Users]    Script Date: 31/08/2025 01:02:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Listings]  WITH CHECK ADD  CONSTRAINT [Listings_Users_fk] FOREIGN KEY([user_id])
REFERENCES [dbo].[Users] ([user_id])
GO
ALTER TABLE [dbo].[Listings] CHECK CONSTRAINT [Listings_Users_fk]
GO
